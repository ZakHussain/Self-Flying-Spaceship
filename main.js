...
const map = new Map(aiCanvas.height/2, aiCanvas.height*0.9);
// note that the values are in pixels
const length = 30;
const height = 50;
const startx = 50;
const starty = map.getMapLane(1);
const spaceship = new Spaceship(startx-150, starty, length, height, "AI", 3);
const obstacles = [
...
function animate () {
    ...
    aiCanvas.width=window.outerWidth; // reupdating the canvase prevents the trail left behind
